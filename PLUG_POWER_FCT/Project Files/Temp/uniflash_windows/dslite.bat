...
set GENERATED_COMMAND=-c user_files/configs/tms570ls1114.ccxml -l user_files/settings/generated.ufsettings -s VerifyAfterProgramLoad="No verification" -e -f -v "user_files/images/bootloader_valid_app_word.out" "user_files/images/SuperSMC_Bootloader.out" "user_files/images/SuperSMC_Tester.out" 
set ADDITIONALS=
